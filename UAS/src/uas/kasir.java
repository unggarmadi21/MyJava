                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(kode_barang, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(jLabel3)
                                        .addGap(18, 18, 18)
                                        .addComponent(harga_barang, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
                                        .addComponent(jLabel4))
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(jLabel2)
                                        .addGap(18, 18, 18)
                                        .addComponent(nama_barang, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)))
...
//                JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION)
    ...
    private void TotalHargaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TotalHargaActionPerformed
        // TODO add your handling code here:
         ...
         int jumlahBarang = Integer.parseInt(quantity.getText());
         int t = hargaBarang * jumlahBarang;
        
        total_harga.setText(Integer.toString(t));
    }//GEN-LAST:event_TotalHargaActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
           try {
            String sql = "INSERT INTO kasir VALUES ('"+no.getText()+"','"+kode_barang.getText()+"','"+harga_barang.getText()+"','"
                   +nama_barang.getText()+"','"+quantity.getText()+"','"+total_harga.getText()+"')";
        ...
        DefaultTableModel table = (DefaultTableModel)jTable1.getModel();
           table.addRow(new Object []{no.getText(), kode_barang.getText(),
           nama_barang.getText(), harga_barang.getText(), quantity.getText(),
           });
